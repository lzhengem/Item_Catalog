...
APP_PATH='/var/www/FlaskApp/Item_Catalog/'
...
if os.getenv('FLASK_ENV') == 'production':
    ...
    debug = True
    engine = create_engine('postgresql+psycopg2://catalog:password@localhost/item_catalog')
...
def gconnect():
    ...
    try:
        ...
        CLIENT_ID = json.loads(open(APP_PATH + 'client_secrets.json',
                                    'r').read())['web']['client_id']
        CLIENT_SECRET = json.loads(open(APP_PATH + 'client_secrets.json',
